...
interface HamsterWheelContentProps {
  hamsterState: "idle" | "running" | "stopping";
...
export const HamsterWheelContent = ({
  ...
  const isRunning = hamsterState === "running";
  const isStopping = hamsterState === "stopping";
  const isIdle = hamsterState === "idle";
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 md:p-8">
      ...
      <div className="text-[10px] md:text-xs mt-4 md:mt-8 p-3 md:p-4 rounded-lg font-mono bg-gray-800 text-gray-400 w-[200px] md:w-[225px]">
        <div>State: {hamsterState}</div>
        <div>Wheel Rotation: {wheelRotation.toFixed(0)}°</div>
        <div>Electricity: {electricityLevel}%</div>
